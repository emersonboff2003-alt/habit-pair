...
export function Header({ current, profiles }: HeaderProps) {
  return (
    <header className="safe-top sticky top-0 z-30 border-b border-zinc-800/80 bg-background/90 backdrop-blur">
      <div className="mx-auto flex max-w-md items-center justify-between gap-2 px-4 py-3">
        <Link href="/" className="flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-cyan-400">
