  ...
  return (
    <div
      className={cn(
        ...
        affordable ? "border-zinc-800" : "border-zinc-800 opacity-60",
      )}
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {reward.description && (
          <p className="mt-0.5 line-clamp-2 text-xs text-zinc-500">{reward.description}</p>
        )}
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Trocar <strong className="text-zinc-100">{reward.cost_points} pontos</strong> por{" "}
              <strong className="text-zinc-100">{reward.title}</strong>?
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-950/50 p-3 text-sm">
            ...
            <div className="mt-1 flex justify-between border-t border-zinc-800 pt-1">
              <span className="text-zinc-400">Saldo após</span>
